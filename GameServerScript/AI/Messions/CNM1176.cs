...
namespace GameServerScript.AI.Messions
{
    public class CNM1176 : AMissionControl
    {
        ...
        private int m_state = 0x498;
        private int turn = 0;
        private int firstBossID = 0x498;
        private int secondBossID = 0x499;
        private int npcID = 2;
        ...
        public override void OnStartGame()
        {
            ...
            this.m_king = base.Game.CreateBoss(this.m_state, 900, 590, -1, 0);
            this.m_king.FallFrom(900, 690, "fall", 0, 2, 0x3e8);
