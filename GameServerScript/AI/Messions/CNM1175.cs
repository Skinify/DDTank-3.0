...
namespace GameServerScript.AI.Messions
{
    public class CNM1175 : AMissionControl
    {
        ...
        public override bool CanGameOver()
        {
            ...
            return (this.m_count == base.Game.TotalCount) || ((base.Game.TurnIndex > (base.Game.TotalTurn - 1)) && (this.m_count != base.Game.TotalCount)) || (this.m_door.CurrentAction == "end");
        }
